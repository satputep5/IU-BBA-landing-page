    ...
    <div className="px-8 md:px-16 py-12 poppins-regular">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-16">
        ...
        >
          ...
          <h2 className="mt-4 text-[#388A86]">Program Format</h2>
          <p className="mt-2 text-xl font-semibold text-[#388A86]">Offline</p>
        </div>
        ...
        >
          ...
          <h2 className="mt-4 text-[#388A86]">Duration</h2>
          <p className="mt-2 text-xl font-semibold text-[#388A86]">3 Years</p>
        </div>
        ...
        >
          ...
          <h2 className="mt-4 text-[#388A86]">Program Fees</h2>
          <p className="mt-2 text-xl font-semibold text-[#388A86]">Rs. 1,25,000/-</p>
        </div>
      </div>
    </div>
  );
