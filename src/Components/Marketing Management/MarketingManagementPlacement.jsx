    ...
    <div className="px-8 md:px-16 py-4">
      <div className="flex space-x-4 flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#2C7667] not-first-of-type: mb-4">Top Placements</h2>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#2C7667] mt-2 md:mt-0 mb-4">Our Recruiters</h2>
          {/* Recruiters Grid */}
