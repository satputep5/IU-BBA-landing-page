  ...
  return (
    <div className="px-4 md:px-16 py-4 ">
      <div className="flex space-x-4 flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center mb-4">
          {/* Heading for Placement Section */}
          <h2 className="text-3xl md:text-4xl font-semibold text-[#1D3557] mb-4">Top Placements</h2>
          {/* Placement Image */}
          <img
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#1D3557] mb-4">Our Recruiters</h2>
          {/* Recruiters Grid */}
