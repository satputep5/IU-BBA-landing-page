      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-16">
        ...
        >
          <div className="flex items-center justify-center mr-4 space-x-4">
            {/* Changed icon color to Electric Teal */}
            <FaCalendarAlt size={40} className="text-blue-500" />
            <div className="text-center">
              <h2 className="text-[#00B4D8]">Program Format</h2>
              <p className="mt-2 text-2xl font-semibold text-[#00B4D8]">Offline</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-center mr-4 space-x-4">
            ...
            <div className="text-center">
              <h2 className="text-[#00B4D8]">Duration</h2>
              <p className="mt-2 text-2xl font-semibold text-[#00B4D8]">4 Years</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-center mr-4 space-x-4">
            ...
            <div className="text-center">
              <h2 className="text-[#00B4D8]">Program Fees</h2>
              <p className="mt-2 text-2xl font-semibold text-[#00B4D8]">Rs. 108000/-</p>
            </div>
          </div>
        </div>
      </div>
