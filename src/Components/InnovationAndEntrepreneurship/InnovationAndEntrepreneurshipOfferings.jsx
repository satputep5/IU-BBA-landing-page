  ...
  return (
    <div className="px-8 md:px-16 py-6 md:py-8 bg-[#f3f4f6] poppins-regular">
      <h2 className="text-2xl md:text-4xl font-bold text-center mb-8 text-[#1f2937]" data-aos="fade-up">
        Why Indira University for BBA in Innovation & Entrepreneurship?
      </h2>
      ...
      <div className="flex justify-center gap-6 flex-wrap">
        ...
        >
          ...
          <p className="text-sm text-white mt-2">Learn from case studies of startups like Paytm & Byju’s.</p>
        ...
        >
          ...
          <p className="text-lg font-semibold text-white">Business Incubators for BBA Students</p>
          <p className="text-sm text-white mt-2">Get mentorship and funding for your startup.</p>
          <div className="circle absolute bottom-[-20px] right-[-20px] w-12 h-12 bg-white rounded-full shadow-2xl"></div>
        </div>
        ...
        >
          ...
          <p className="text-sm text-white mt-2">Work with real founders & venture capitalists.</p>
          <div className="circle absolute bottom-[-20px] right-[-20px] w-12 h-12 bg-white rounded-full shadow-2xl"></div>
        </div>
        ...
        >
          ...
          <p className="text-lg font-semibold text-white">Startup Funding Options</p>
          <p className="text-sm text-white mt-2">Connect with investors and accelerators to secure seed capital.</p>
          <div className="circle absolute bottom-[-20px] right-[-20px] w-12 h-12 bg-white rounded-full shadow-2xl"></div>
        </div>

        {/* Additional Card for Exclusive Guest Lectures */}
        <div
        ...
        >
          ...
          <p className="text-sm text-white mt-2">Learn from CEOs, Startup Mentors & Angel Investors.</p>
          <div className="circle absolute bottom-[-20px] right-[-20px] w-12 h-12 bg-white rounded-full shadow-2xl"></div>
        </div>
      </div>
    </div>
