...
import backgroundImage from '../../assets/Images/nb-wave.jpg';  // Import your background image
  ...
  return (
    <div className="relative overflow-hidden ">
      ...
      >
        {/* Black Overlay */}
        <div
          className="absolute top-0 left-0 w-full h-full bg-blue-900 opacity-50 "
        ></div>
