    ...
    <div className="px-8 md:px-16 py-4">
      <div className="flex flex-col md:flex-row  space-x-4 space-y-4">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#264653] mb-4">Top Placements</h2>
          {/* Placement Image */}
          <img
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#264653] mb-4">Our Recruiters</h2>
          {/* Recruiters Grid */}
